...
public class UserDataManager extends JFrame implements ActionListener {
    ...
    public UserDataManager(UserManager userManager, String[] data) {
        ...
        if (e.getSource() == saveButton) {
            ...
            try {
                ...
                if (ageInt < 0 || ageInt > 100) {
                    JOptionPane.showMessageDialog(this, "Please enter a valid age between 1 to 100", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
